...
public class Utilitarios {
    public static void aplicarFormatacaoCampos(Container container) {
        ...
        for (Component component : container.getComponents()) {
            if (component instanceof JTextField) {
                ...
                configurarParaMaiusculasAoFocarEDigitar(textField);
            } else if (component instanceof JComboBox) {
                JComboBox<?> comboBox = (JComboBox<?>) component;
                if (comboBox.isEditable()) {
                    Component editorComponent = comboBox.getEditor().getEditorComponent();
                    if (editorComponent instanceof JTextField) {
                        configurarParaMaiusculasAoFocarEDigitar((JTextField) editorComponent);
                    }
                }
    ...
    private static void configurarParaMaiusculasAoFocarEDigitar(JTextField textField) {
        if (textField == null) {
            return;
        }
    ...
    public static String mostrarDialogoComCampoMaiusculo(Component parent, String mensagem, String titulo, String valorInicial) {
